...
func (d *replaceDirective) Initialize(ctx *dbctx.DBContext, stmt *StmtInfo, tok etree.Token) error {
...
func (d *wildcardDirective) Initialize(ctx *dbctx.DBContext, stmt *StmtInfo, tok etree.Token) error {
	elem := tok.(*etree.Element)
...
func ExtractWildcardInfo(stmt *StmtInfo) *WildcardInfo {
